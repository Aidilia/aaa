...
<div class="container">
    <header class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4 border-bottom">
        <ul class="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
            ...
            <li><a href="/LKS-CLOUDBABEL2024-main/app/daftar_sekolah.php" class="nav-link px-2 link-dark">Daftar Sekolah</a></li>
            <li><a href="/LKS-CLOUDBABEL2024-main/app/daftar_guru.php" class="nav-link px-2 link-dark">Daftar Guru & Staft</a></li>
